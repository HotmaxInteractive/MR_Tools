...
namespace NewtonVR
{
    public class NVRPhysicalController : MonoBehaviour
    {
        ...
        private Type[] KeepTypes = new Type[] {typeof(MeshFilter), typeof(Renderer), typeof(Transform), typeof(Rigidbody), typeof(Canvas), typeof(CanvasRenderer), typeof(RadialMenu), typeof(FlareLayer), typeof(Camera) };
